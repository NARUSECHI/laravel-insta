        ...
        <div class="card border-0">
            <div class="card-header bg-white py-3">
                <div class="row align-item-center">
                    ...
                    <div class="col ps-0">
                        <a href="{{ $post->user->avatar }}" class="text-decoration-none text-dark">{{ $post->user->name}}</a>
                    </div>
                    <div class="col-auto">
                        ...
                        @if (Auth::user()->id === $post->user->id)
                            <div class="dropdown">
                                ...
                                <div class="dropdown-menu">
                                    ...
                                    <button class="dropdown-item text-danger" data-bs-taggle="modal" data-bs-target="delete-post-{{ $post->id }}">
                        ...
                        @else
                        {{-- If you are not the owner of the post, show a follow/unfollow button. Show the follow button for now --}}
            ...
            <div class="card-body w-100">
                {{--  heart button + the no. of likes + categories --}}
                ...
                <p class="text-uppercase text-muted xsmall">{{ date('d M,Y',strtotime($post->created_at))}}</p>
                    ...
                    @foreach ($post->comments as $comment)
                        <li class="list-group-item border-0 p-0 mb-2">
                            ...
                            <form action="{{route('comment.destroy',$comment->id)}}" method="post">
                                ...
                                {{-- If the auth is the owner of the comeent, sho a delete btn. --}}
